    ...
    <>
      <div>
        <div className="pb-6 pt-6">
          <h1 className="text-2xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:hidden sm:text-2xl sm:leading-10 md:text-4xl md:leading-14">
            {title}
          </h1>
        </div>
        <div className="flex sm:space-x-24">
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded bg-gray-50 pt-5 shadow-md dark:bg-gray-900/70 dark:shadow-gray-800/40 sm:flex">
            <div className="px-6 py-4">
              ...
              <ul>
                {sortedTags
                  .filter((t) => t !== 'news') // Filter out 'news' tag
                  .map((t) => {
                    return (
          ...
          <div>
            <ul>
              {displayPosts
                .filter((post) => !post.tags.includes('news')) // Filter out posts with 'news' tag
                .map((post) => {
