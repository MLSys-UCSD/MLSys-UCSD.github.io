...
import { allPublications, allAuthors } from 'contentlayer/generated'
import type { Authors, Publication } from 'contentlayer/generated'
import Pub from '@/layouts/Pub'
import { Metadata } from 'next'
import siteMetadata from '@/data/siteMetadata'
import { notFound } from 'next/navigation'

const defaultLayout = 'Pub'
const layouts = {
  Pub,
}
...
export const generateStaticParams = async () => {
  const paths = allPublications.map((p) => ({ slug: p.slug.split('/') }))
